package com.lr.titan.repository.script;
import com.lr.titan.repository.model.TitanModel;
import com.lr.titan.repository.utils.ParseAnnotation;
...
//                LOG.error("读取脚本文件{}出错",name);
    ...
    private ScriptResult updateEducationRedPropertyM(String identifier){
        ScriptResult result = new ScriptResult(ScriptMethod.UPDATE_EDUCATION_RED_PROPERTY);
        result.setInvokeMethod(ScriptMethod.UPDATE_EDUCATION_RED_PROPERTY.methodName +"("+identifier+")");
        return result;
    }

    private ScriptResult updateRelationRedPropertyM(String identifier){
        ScriptResult result = new ScriptResult(ScriptMethod.UPDATE_RELATION_RED_PROPERTY);
        result.setInvokeMethod(ScriptMethod.UPDATE_RELATION_RED_PROPERTY.methodName +"("+identifier+")");
        return result;
    }

    private ScriptResult updateRelationRedPropertyFromEduM(String primaryCategory, String identifier){
        ScriptResult result = new ScriptResult(ScriptMethod.UPDATE_RELATION_RED_PROPERTY_FROM_EDU);
        result.setInvokeMethod(ScriptMethod.UPDATE_RELATION_RED_PROPERTY_FROM_EDU.methodName +"("+primaryCategory+","+identifier+")");
        return result;
    }

    private ScriptResult butchUpdateRelationRedPropertyM(String edgeList){
        ScriptResult result = new ScriptResult(ScriptMethod.BUTCH_UPDATE_RELATION_RED_PROPERTY);
        result.setInvokeMethod(ScriptMethod.BUTCH_UPDATE_RELATION_RED_PROPERTY.methodName +"("+edgeList+")");
        return result;
    }
    ...
    public TitanScriptBuilder updateEducationRedProperty(String identifier){
        ...
        HashMap<String,Object> param = new HashMap<>();
        String paramName = variable.getVariable();
        ScriptResult scriptMethod = updateEducationRedPropertyM(paramName);
    ...
    public TitanScriptBuilder butchUpdateRelationRedProperty(List<String> identifierLies){
        ...
        HashMap<String,Object> param = new HashMap<>();
        String paramName = variable.getVariable();
        ScriptResult updateEducationRedProperty = butchUpdateRelationRedPropertyM(paramName);

        param.put(paramName,identifierLies);
        appendScriptMethod(updateEducationRedProperty.getScriptMethod());
        appendScriptMethod(ScriptMethod.UPDATE_RELATION_RED_PROPERTY);
        this.param.putAll(param);
    ...
    public TitanScriptBuilder updateRelationRedPropertyFromEdu(String primaryCategory, String identifier){
        ...
        Variable variable = createVariable(TitanScriptModel.Type.V);
        HashMap<String,Object> param = new HashMap<>();
        String paramIdentifier = variable.getVariable();
        String paramPrimaryCategory = variable.getVariable();
        ScriptResult updateEducationRedProperty = updateRelationRedPropertyFromEduM(paramPrimaryCategory, paramIdentifier);
    ...
    public TitanScriptBuilder updateRelationRedProperty(String identifier){
        ...
        HashMap<String,Object> param = new HashMap<>();
        String paramName = variable.getVariable();
        ScriptResult updateEducationRedProperty = updateRelationRedPropertyM(paramName);
